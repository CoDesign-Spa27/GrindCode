...
export function Footer() {
  ...
  const LogoSVG = useMemo(() => {
    return theme === "dark" ? <CodeSvg /> : <CodeSvg />;
  }, [theme]);
  ...
  return (
    <footer>
      <div className="mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row md:gap-2 justify-between items-center   md:text-left">
       
          <div className="flex justify-center md:justify-start">
            <Link href="/">
              <div className="font-extrabold flex text-white items-center gap-1 text-xl sm:text-2xl tracking-wide">
