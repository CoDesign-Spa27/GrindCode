      ...
      <div className="flex items-center justify-between">
        ...
        <nav className='hidden sm:block'>
         ...
         <div className='flex gap-4'>
           <Link
            className="text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
            href="/your-rooms">
             My Rooms
            </Link> 
