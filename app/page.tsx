...
export default function LandingPage() {
  ...
  return (
    <main className="bg-gradient-to-r w-full min-h-screen from-rose-200 to-teal-200 dark:bg-gradient-to-r dark:from-slate-900 dark:via-purple-950 dark:to-slate-900">
      <section className="pt-16 w-full  md:pt-48">
